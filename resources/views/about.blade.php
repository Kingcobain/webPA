...
<body>
    <section class="bg-cream">
        <div class="container">
            <div class="row my-5">
              <h2 class="mt-0 mb-4 text-center">About Us</h2>
              <div class="row row-cols-1 row-cols-md-4 g-3 justify-content-md-center">
                <div class="col">
                  <div class="card">
                    <img src="img/rafi.jpg" class="card-img-top" alt="rafi">
                    <div class="card-body">
                      <h5 class="card-title text-center">Rafi Uletta Giovanni</h5>
                      <p class="card-text text-center">Fullstack Developer</p>
                    </div>
                  </div>
                </div>
                <div class="col">
                ...
                <div class="col">
                  <div class="card">
                    <img src="img/rafi.jpg" class="card-img-top" alt="rafi">
                    <div class="card-body">
                      <h5 class="card-title text-center">Gibran</h5>
                      <p class="card-text text-center">Desainer</p>
                    </div>
                  </div>
                </div>
              </div>
