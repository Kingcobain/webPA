...
<html lang="en-us">
  <head>
    ...
    <title>Unity WebGL Player | IMath</title>
  ...
  <body>
    <div id="unity-container" class="unity-desktop" style="position: relative top-50 start-0 translate-middle">
    ...
    <script>
      ...
      var buildUrl = "Build";
      var loaderUrl = buildUrl + "/IMath.loader.js";
      var config = {
        dataUrl: buildUrl + "/IMath.data.unityweb",
        frameworkUrl: buildUrl + "/IMath.framework.js.unityweb",
        codeUrl: buildUrl + "/IMath.wasm.unityweb",
